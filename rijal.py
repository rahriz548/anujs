...
#AKUN SELFBOT+ASIST
#===================================================================================================
cl = LINE("EBBMpvrMP8N7l9ixtlS9./egLPpCcN+kOUcn/wlbQMq.i3YWuGn1Erg93nM50MYUGmJRyvNFabil647mG5xs7cw=")
cl.log("Auth Token : " + str(cl.authToken)) #SELFBOT

ki = LINE("EAbfcdMQAM1ddk2EFguc.VzncrWgGafOqS4nYeri+Ja.HwM9RHR8t9dcR+Fbn9pZMUecSjKqZDipviY6WLrMpmE=")
ki.log("Auth Token : " + str(ki.authToken)) #ASIST1

kk = LINE("EAqoXcKM4H4cw0TAm4q5.xF2nAFd1rjMeOuV9W3dCbq.tXd81W+xLWLuOaH80DbgRefW7ywleodbKHEE27Io5e4=")
kk.log("Auth Token : " + str(kk.authToken)) #ASIST2

kc = LINE("EAV0PYtSKhDbzJCiN6U0.lEdJnW2tvHyyTwzQDLgkGa.fI19DRrHWU2vaQQOMtlpsPmdzIZUgdSuCRlbXARNhd8=")
kc.log("Auth Token : " + str(kc.authToken)) #ASIST3

km = LINE("EAHSGB7tTBiSZzMLkTBa.Lq7f3hP7lvR6xO3mgK7DwG.ZrEB0vGQ1IvqiidLgUvM0lFsOH8TR4LosQdvPZEKzkg=")
km.log("Auth Token : " + str(km.authToken)) #ASIST4

kb = LINE("EAKrfoHOZk0lVqtRffx7.YkwMmFMNo3DzqJ2t9MG+nW.WtMsiKtaVfm6Di2D1kqiSohzbnNxDGjcyDiP1oTl1j8=")
kb.log("Auth Token : " + str(kb.authToken)) #ASIST5

ka = LINE("EASob7D6zW25MufeJDHe.ywWafp98VaihnkrxeXq8RG.b7srn4TU5kyTQdqXrKqvbyv8vk0tyd6LDUc1xjODJfU=")
ka.log("Auth Token : " + str(ka.authToken)) #ASIST6

kr = LINE("EA1hwbpzbMvGn9DpCY51.4fAAzH7rWD1lwMaLhTqtWq.gKyNt3KecugydY4sPDRJ2Eh89EDqZyHVmtEGGMYCzEk=")
kr.log("Auth Token : " + str(kr.authToken)) #ASIST7

sw = LINE("EAlCX0key5OVMdu8UJQe.uwBhkehJMRCODAGtFvTVZG.nN6HJyCU+uJA3ZFZRpsqM3d1h3yl1j6UfX2w2IHa3SA=")
sw.log("Auth Token : " + str(sw.authToken)) #ASIST8

dz = LINE("EAjEHqnaWKp2tQuJm0d6.c9lOqhqVKP+PPrAQ4JVkTG.9bl506fvFd/OI9BML2hLyjhu/Z+fIKzowd4qYoV0qU8=")
dz.log("Auth Token : " + str(dz.authToken)) #ASIST9
#==============================================================================
#==========================[[TOKEN CHROME]]=====================================
#==============================================================================
#==============================================================================================================
...
oepoll = OEPoll(cl)
call = cl
creator = ["uf841a5a4f7029ff2a8b8237e58b06a99"]
owner = ["uf841a5a4f7029ff2a8b8237e58b06a99"]
admin = ["uf841a5a4f7029ff2a8b8237e58b06a99"]
staff = ["uf841a5a4f7029ff2a8b8237e58b06a99"]
...
Gmid = kr.getProfile().mid
Zmid = sw.getProfile().mid
Dhenza = dz.getProfile().mid
KAC = [cl,ki,kk,kc,km,kb,ka,kr]
ABC = [ki,kk,kc,km,kb,ka,kr]
ABCD = [ki,kk,kc,km,kb,ka,kr,sw,dz]
GHOST = [sw,dz]
Bots = [mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Zmid,Dhenza]
...
responsename7 = kr.getProfile().displayName
#===============================================================================
settings = {
    "autoBlock": False,
    "autoRead": False,
...
wait = {
    ...
    "sticker":False,  
    "selfbot":True,
    "mention":"Masuk woe ngitip cipok",
    "Respontag":"NGETAG SEKALI LAGI CANTENGAN TU JEMPOL",
    "welcome":"WELCOME\nYANG BETAH YA\n moga secepetnya dapet tikungan",
    "leave":"NAH NAH NAH LEMPER\nPAPAY KAWAN\nSEMOGA LAIN WAKTU DPET TIKUNGAN Y BIAR KAGAK LEMPER LAGI",
...
def sendMentionFooter(to, text="", mids=[]):
    ...
    cl.sendMessage(to, textx, {'AGENT_NAME':'@??????2??????r???? on Instagram', 'AGENT_LINK': 'https://www.instagram.com/aditmadzs1', 'AGENT_ICON': "http://dl.profile.line-cdn.net/" + cl.getProfile().picturePath, 'MENTION': str('{"MENTIONEES":' + json.dumps(arr) + '}')}, 0)
...
def sendMessageWithFooter(to, text):
 ...
 pict = "http://dl.profile.line-cdn.net/"+cl.pictureStatus
 name = "「 ??????2??????r???? 」"
 Aditmadzs = {"AGENT_ICON": pict,
     "AGENT_NAME": name,
     "AGENT_LINK": ticket
 }
 cl.sendMessage(to, text, contentMetadata=Aditmadzs)
...
def help():
    ...
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "Sleave: text\n"
    num = (num+1)
    ...
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "Leave「on/off」\n"
    num = (num+1)
    helpMessage += "┃ " + "├──────────────\n"
    helpMessage += "┃ " + "╰──⍟ᴛᴇᴀᴍ ʙᴏᴛ ᴘʀᴏᴛᴇᴄᴛ⍟──\n"
    helpMessage += "╰━━━━━━━━━━━━━━━━"
...
def helpbot():
    ...
    num = (num+1)
    helpMessage2 += "╠❂➣ %i. " % num + key + "Mlebet\n"
    num = (num+1)
    helpMessage2 += "╠❂➣ %i. " % num + key + "Wangsul\n"
    num = (num+1)
    ...
    num = (num+1)
    helpMessage2 += "╠❂➣ %i. " % num + key + "Anu on/off\n"
    num = (num+1)
    helpMessage2 += "╠❂➣ %i. " % num + key + ".Bye/Bye[1/4]\n"
    num = (num+1)
    helpMessage2 += "╠❂➣ %i. " % num + key + "Leave「Namagrup」\n"
    num = (num+1)    
    helpMessage2 += "╠❂➣ %i. " % num + key + "anu「in」\n"
    num = (num+1)  
    helpMessage2 += "╠❂➣ %i. " % num + key + "anu「lv」\n"
    num = (num+1)    
    helpMessage2 += "╠❂➣ %i. " % num + key + "Infogrup「angka」\n"
    num = (num+1)
    helpMessage2 += "╠❂➣ %i. " % num + key + "Infomem「angka」\n"
    num = (num+1)     
    helpMessage2 += "╠❂➣ %i. " % num + key + ".ugh [kickall]\n"
    num = (num+1)
    helpMessage2 += "╠❂➣ %i. " % num + key + ".meneng [kickall]\n"
    num = (num+1)
    helpMessage2 += "╠❂➣ %i. " % num + key + "anu \n"
    num = (num+1)
            ...
            if mid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        cl.acceptGroupInvitation(op.param1)
                        ginfo = cl.getGroup(op.param1)
                        cl.sendMessage(op.param1,"Aku teko " +str(ginfo.name))
                    else:
                        cl.acceptGroupInvitation(op.param1)
                        ginfo = cl.getGroup(op.param1)
                        cl.sendMessage(op.param1,"Aku teko " + str(ginfo.name))
                                ...
                                try:
                                    ...
                                    try:
                                        ...
                                        try:
                                            ...
                                            try:
                                                ka.cancleGroupInvitation(op.param1,[op.param2])
                                            except:
                                                try:
                                                    kr.cancleGroupInvitation(op.param1,[op.param2])
                                                except:
                                                    pass
        ...
        if op.type == 19 or op.type == 32:
                    ...
                    try:
                        ...
                        try:
                            ...
                            try:
                                ...
                                try:
                                    km.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid])
                                    km.kickoutFromGroup(op.param1,[op.param2])
                                    cl.acceptGroupInvitation(op.param1)
                                    ...
                                    try:
                                        ...
                                        try:
                                            ka.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid])
                                            ka.kickoutFromGroup(op.param1,[op.param2])
                                            cl.acceptGroupInvitation(op.param1)
                                            kr.cancelGroupInvitation(op.param1,[op.param2])
                                            wait["blacklist"][op.param2] = True
                                        except:
                                            try:
                                                kr.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid])
                                                kr.kickoutFromGroup(op.param1,[op.param2])
                                                cl.acceptGroupInvitation(op.param1)
                                                ki.cancelGroupInvitation(op.param1,[op.param2])
                                                wait["blacklist"][op.param2] = True
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    try:
                                        ...
                                        try:
                                            cl.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid])
            ...
            if Gmid in op.param3:
                ...
                if op.param2 in staff:
                    ...
                    try:
                        cl.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid])
                        clkickoutFromGroup(op.param1,[op.param2])
                        kr.acceptGroupInvitation(op.param1)
                        ki.cancelGroupInvitation(op.param1,[op.param2])
                        wait["blacklist"][op.param2] = True
                    except:
                              ...
                              try:
                                  ...
                                  try:
                                     ...
                                     try:
                                         if op.param3 not in wait["blacklist"]:
                                             ka.kickoutFromGroup(op.param1,[op.param2])
                                             ka.inviteIntoGroup(op.param1,[Dhenza])
                                             cl.sendMessage(op.param1, "🇦🇱JΔΠGΔΠ DI CΔΠCΣL ANTI KICKER ITU🇦🇱")
                                     except:
                                        try:
                                            if op.param3 not in wait["blacklist"]:
                                                kr.kickoutFromGroup(op.param1,[op.param2])
                                                kr.inviteIntoGroup(op.param1,[Dhenza])
                                                cl.sendMessage(op.param1, "🇦🇱JΔΠGΔΠ DI CΔΠCΣL ANTI KICKER ITU🇦🇱")
                                        except:
                                             pass
              return
                    ...
                    if msg_id in msg_dict:
                        if msg_dict[msg_id]["from"]:
                           if msg_dict[msg_id]["text"] == 'Gambarnya dibawah':
                                ...
                                zxc = ""
                                zx2 = []
                                xpesan =  " Hayoooo di hapuuusss ,,,Pasti anu tu gambarnya,,,coba ane liat \n Pengirim : "
                                ...
                                ginfo = cl.getGroup(at)
                                ryan = cl.getContact(msg_dict[msg_id]["from"])
                                ret_ =  " Hayoooo di hapuuusss ,,,Pasti anu tu pesanya,,,coba ane liat \n"
                ...
                try:
                    ...
                    if msg_id in msg_dict1:
                        if msg_dict1[msg_id]["from"]:
                                ...
                                ret_ =  " Hayoooo di hapuuusss ,,,Sticker anu ya,,,coba ane liat \n"
                                ret_ += " Pengirim : {}".format(str(ryan.displayName))
                                ret_ += "\n Nama Grup : {}".format(str(ginfo.name))
            ...
            if msg.toType == 2:
               ...
               if msg.contentType == 16:
                    if wait["Timeline"] == True:
                            ...
                            ka.likePost(url[25:58], url[66:], likeType=1001)
                            kr.likePost(url[25:58], url[66:], likeType=1001)
                            ...
                            ka.createComment(url[25:58], url[66:], wait["comment"])
                            kr.createComment(url[25:58], url[66:], wait["comment"])
               if msg.contentType == 0:
                    msg_dict[msg.id] = {"text":msg.text,"from":msg._from,"createdTime":msg.createdTime}
               if msg.contentType == 1:
                    path = cl.downloadObjectMsg(msg_id)
               ...
               if msg.contentType == 1:
                 if msg._from in admin:
                   if settings["changePicture"] == True:
                     ...
                     path7 = kr.downloadObjectMsg(msg_id)
                        ...
                        if cmd == "on":
                          ...
                          if wait["selfbot"] == True:
                    	    ...
                    	    if msg._from in admin: 
                              ...
                              cl.sendMessage(msg.to, None,contentMetadata={'mid': sender}, contentType=13)
                               ...
                               cl.sendMessage(msg.to, "Dalem,,")
                        elif text.lower() == 'sepi':
                               cl.sendMessage(msg.to, "Iyalah orang kk ngintip akuh gi mandi mulu????????????????,,")
                        elif text.lower() == 'rame':
                               cl.sendMessage(msg.to, "Iya dooong joget kak biar tambah rame????????????????,,")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               cl.sendMessage(msg.to, None, contentMetadata={'mid': key1}, contentType=13)
                               cl.sendMessage(msg.to, "Hobi : Ngintip janda lagi mandi ")
                          ...
                          if msg._from in admin:
                            try:
                                ...
                                ka.findAndAddContactsByMid(Amid)
                                ...
                                ka.findAndAddContactsByMid(Zmid)
                                ka.findAndAddContactsByMid(Dhennza)
                                ...
                                kr.findAndAddContactsByMid(mid)
                                kr.findAndAddContactsByMid(Amid)
                                kr.findAndAddContactsByMid(Bmid)
                                kr.findAndAddContactsByMid(Cmid)
                                kr.findAndAddContactsByMid(Dmid)
                                kr.findAndAddContactsByMid(Emid)
                                kr.findAndAddContactsByMid(Fmid)
                                kr.findAndAddContactsByMid(Zmid)
                                kr.findAndAddContactsByMid(Dhennza)
                                kr.findAndAddContactsByMid(Drop_Xv)
                                kr.findAndAddContactsByMid(Xv_WIN)
                                kr.findAndAddContactsByMid(Xv_LAN)
                                kr.findAndAddContactsByMid(Xv_Servic)
                                kr.findAndAddContactsByMid(Xv_DxD)
                                ...
                                dz.findAndAddContactsByMid(Fmid)
                                dz.findAndAddContactsByMid(Zmid)
                                dz.findAndAddContactsByMid(Gmid)
                          ...
                          if msg._from in admin:
                              ...
                              ka.sendMessage(msg.to,Fmid)
                              kr.sendMessage(msg.to,Gmid)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              ...
                              if ginvited != [] and ginvited != None:
                                  ...
                                  kr.sendMessage(to, "Succes reject {} ".format(str(len(ginvited))))
                              else:
                                  ...
                                  ka.sendMessage(to, "sᴇᴍᴜᴀ ɢʀᴜᴘ sᴜᴅᴀʜ ᴅɪʙᴀᴛᴀʟᴋᴀɴ")
                                  kr.sendMessage(to, "sᴇᴍᴜᴀ ɢʀᴜᴘ sᴜᴅᴀʜ ᴅɪʙᴀᴛᴀʟᴋᴀɴ")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               try:
                                   ...
                                   kr.sendMessage(msg.to,"Bersih bos")
                          ...
                          if msg._from in owner:
                            ...
                            if msg._from in owner:		   
                                ...
                                try:
                                    ...
                                    ka.sendMessage(to,"Succes leave to group " + gids.name)
                                    kr.sendMessage(to,"Succes leave to group " + gids.name)
                        elif cmd.startswith("metuall "):
                          if msg._from in owner:
                            separate = msg.text.split(" ")
                            number = msg.text.replace(separate[0] + " ","")
                            groups = cl.getGroupIdsJoined()
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for i in gid:
                                   ...
                                   ma += "╠ " + str(a) + ". " +G.name+ "\n"
                               cl.sendMessage(msg.to,"╔══[ LIST GRUP  ]\n║\n"+ma+"║\n╚══[ Total「"+str(len(gid))+"」Groups ]")
                            ...
                            if msg._from in admin:
                               ...
                               for i in gid:
                                   ...
                                   ma += "╠ " + str(a) + ". " +G.name+ "\n"
                               ki.sendMessage(msg.to,"╔══[ LIST GRUP ]\n║\n"+ma+"║\n╚══[ Total「"+str(len(gid))+"」Groups ]")
                            ...
                            if msg._from in admin:
                               ...
                               for i in gid:
                                   ...
                                   ma += "╠ " + str(a) + ". " +G.name+ "\n"
                               kk.sendMessage(msg.to,"╔══[ LIST GRUP ]\n║\n"+ma+"║\n╚══[ Total「"+str(len(gid))+"」Groups ]")
                            ...
                            if msg._from in admin:
                               ...
                               for i in gid:
                                   ...
                                   ma += "╠ " + str(a) + ". " +G.name+ "\n"
                               kc.sendMessage(msg.to,"╔══[ LIST GRUP  ]\n║\n"+ma+"║\n╚══[ Total「"+str(len(gid))+"」Groups ]")
                            ...
                            if msg._from in admin:
                               ...
                               for i in gid:
                                   ...
                                   ma += "╠ " + str(a) + ". " +G.name+ "\n"
                               km.sendMessage(msg.to,"╔══[ LIST GRUP ]\n║\n"+ma+"║\n╚══[ Total「"+str(len(gid))+"」Groups ]")
                            ...
                            if msg._from in admin:
                               ...
                               for i in gid:
                                   ...
                                   ma += "╠ " + str(a) + ". " +G.name+ "\n"
                               kb.sendMessage(msg.to,"╔══[ LIST GRUP ]\n║\n"+ma+"║\n╚══[ Total「"+str(len(gid))+"」Groups ]")
                            ...
                            if msg._from in admin:
                               ...
                               for i in gid:
                                   ...
                                   ma += "╠ " + str(a) + ". " +G.name+ "\n"
                               ka.sendMessage(msg.to,"╔══[ LIST GRUP ]\n║\n"+ma+"║\n╚══[ Total「"+str(len(gid))+"」Groups ]")
                            ...
                            if msg._from in admin:
                               ...
                               for i in gid:
                                   ...
                                   ma += "╠ " + str(a) + ". " +G.name+ "\n"
                               kr.sendMessage(msg.to,"╔══[ LIST GRUP ]\n║\n"+ma+"║\n╚══[ Total「"+str(len(gid))+"」Groups ]")
                            ...
                            if msg._from in admin:
                               ...
                               for i in gid:
                                   ...
                                   ma += "╠ " + str(a) + ". " +G.name+ "\n"
                               kr.sendMessage(msg.to,"╔══[ LIST GRUP SILENT ]\n║\n"+ma+"║\n╚══[ Total「"+str(len(gid))+"」Groups ]")
...
#===========BOT UPDATE============#                                                          
                        elif cmd == "tagall" or text.lower() == 'tes':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                try:
                                    ...
                                    cl.inviteIntoGroup(msg.to, [Zmid,Dhenza])
...
#====================================================================                            
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                kr.sendMessage(msg.to,responsename8)
                          ...
                          if msg._from in owner:
                            ...
                            try:
                                ...
                                ka.acceptGroupInvitationByTicket(group,Ticket)
                                kr.acceptGroupInvitationByTicket(group,Ticket)
                         ...
                         if msg._from in admin:
                           if msg.toType == 2:
                               ...
                               time.sleep(0.01)
                               kr.acceptGroupInvitationByTicket(to,format(str(ticket)))
                               time.sleep(0.01)
                               G = cl.getGroup(msg.to)
                               G.preventedJoinByTicket = True
                               cl.updateGroup(G)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ki.sendMessage(msg.to, "aku blom punya nama")
                               kk.sendMessage(msg.to, "namaku siapa y")
                               kc.sendMessage(msg.to, "perkenalkan namaku siapa y")
                               km.sendMessage(msg.to, "ada yang tau namaku")
                               kb.sendMessage(msg.to, "hai kk")
                               ka.sendMessage(msg.to, "pasti bosku lupa ngasih nama aku ni")
                               kr.sendMessage(msg.to, "nama bosku ijal silahkan pm dia,,orangnya baik kok")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in owner or msg._from in admin:
                                G = cl.getGroup(msg.to)
                                kr.sendMessage(msg.to, "Pulang dulu "+str(G.name))
...
#====================================================================                            
                        ...
                        elif cmd == "banter" or cmd == "banter":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                get_profile_time_start = time.time()
                                get_profile = cl.getProfile()
                                get_profile_time = time.time() - get_profile_time_start
                                cl.sendMessage(msg.to, "Waiting...")
                                cl.sendMessage(msg.to, "%.10f detik" % (get_profile_time/3))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                get_profile_time = time.time() - get_profile_time_start
                                km.sendMessage(msg.to, "? BOT 4 Speed\n%.10f detik" % (get_profile_time/3))
                                get_profile_time_start = time.time()
                                get_profile = kb.getProfile()
                                get_profile_time = time.time() - get_profile_time_start
                                kb.sendMessage(msg.to, "? BOT 5 Speed\n%.10f detik" % (get_profile_time/3))
                                get_profile_time_start = time.time()
                                get_profile = ka.getProfile()
                                get_profile_time = time.time() - get_profile_time_start
                                ka.sendMessage(msg.to, "? BOT 6 Speed\n%.10f detik" % (get_profile_time/3))
                                get_profile_time_start = time.time()
                                get_profile = kr.getProfile()
                                get_profile_time = time.time() - get_profile_time_start
                                kr.sendMessage(msg.to, "? BOT 7 Speed\n%.10f detik" % (get_profile_time/3))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               elapsed_time = time.time() - start
                               ki.sendMessage(msg.to, "{} detik".format(str(elapsed_time/100)))
                               elapsed_time = time.time() - start
                               kk.sendMessage(msg.to, "{} detik".format(str(elapsed_time/100)))
                               elapsed_time = time.time() - start
                               kc.sendMessage(msg.to, "{} detik".format(str(elapsed_time/100)))
                               elapsed_time = time.time() - start
                               km.sendMessage(msg.to, "{} detik".format(str(elapsed_time/100)))
                               elapsed_time = time.time() - start
                               ka.sendMessage(msg.to, "{} detik".format(str(elapsed_time/100)))
                               elapsed_time = time.time() - start
                               kr.sendMessage(msg.to, "{} detik".format(str(elapsed_time/100)))
...
#====================================================================   
                           ...
                           if msg._from in admin:
                              ...
                              if jumlah <= 1000000:
                                  for var in range(1,jumlah):
                                      ...
                                      dz.sendMessage(midd, None, contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58', 'PRDTYPE': 'THEME', 'MSGTPL': '6'}, contentType=9)
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              ...
                              if jumlah <= 1000000:
                                  for var in range(1,jumlah):
                                      cl.sendMessage(midd, str(Setmain["RAmessage"]))
                                      ki.sendMessage(midd, str(Setmain["RAmessage"]))
                                      kk.sendMessage(midd, str(Setmain["RAmessage"]))
                                      kc.sendMessage(midd, str(Setmain["RAmessage"]))
                                      km.sendMessage(midd, str(Setmain["RAmessage"]))
                                      kb.sendMessage(midd, str(Setmain["RAmessage"]))
                                      ka.sendMessage(midd, str(Setmain["RAmessage"]))
                                      kr.sendMessage(midd, str(Setmain["RAmessage"]))
                                      dz.sendMessage(midd, str(Setmain["RAmessage"]))
                                      sw.sendMessage(midd, str(Setmain["RAmessage"]))
                                    
                        elif 'Mytoken' in msg.text:
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                               cl.sendMessage(msg.to,"SELFBOT\n"+cl.authToken)
                               cl.sendMessage(msg.to,"SELFBOT 1\n"+ki.authToken)
                               cl.sendMessage(msg.to,"SELFBOT 2\n"+kk.authToken)
                               cl.sendMessage(msg.to,"SELFBOT 3\n"+kc.authToken)
                               cl.sendMessage(msg.to,"SELFBOT 4\n"+km.authToken)
                               cl.sendMessage(msg.to,"SELFBOT 5\n"+kb.authToken)
                               cl.sendMessage(msg.to,"SELFBOT 6\n"+ka.authToken)
                               cl.sendMessage(msg.to,"SELFBOT 7\n"+kr.authToken)
                               cl.sendMessage(msg.to,"SELFBOT 9\n"+dz.authToken)
                               cl.sendMessage(msg.to,"SELFBOT 10\n"+sw.authToken)
                                    
                        elif cmd.startswith("spaminvit"):
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              if 'MENTION' in msg.contentMetadata.keys()!=None:
                                    dan = text.split("|")
...
#===========Protection============#
                           ...
                           if msg._from in owner or msg._from in admin:
                              spl = msg.text.replace('Anu ','')
                              if spl == 'on':
                                  if msg.to in protect["antijs"]:
                                       msgs = "Anu has been active"
                                  else:
                        ...
                        elif 'medi ' in msg.text:
                           if msg._from in owner or msg._from in admin:
                             spl = msg.text.replace('medi ','')
                             if spl == 'on':
                                 if msg.to in ghost:
                                      msgs = "Medi sudah aktif"
                                 else:
                                        ghost.append(msg.to)
                                        ginfo = cl.getGroup(msg.to)
                                        msgs = "Medi Diaktifkan\nDi Group : " +str(ginfo.name)
                                 cl.sendMessage(msg.to, "Status:\n" + msgs)
                             elif spl == 'off':
                                   if msg.to in ghost:
                                        ghost.remove(msg.to)
                                        ginfo = cl.getGroup(msg.to)
                                        msgs = "Medi Dinonaktifkan\nDi Group : " +str(ginfo.name)
                                   else:
                                        msgs = "Medi Sudah Tidak Aktif"
                                   cl.sendMessage(msg.to, "Status:\n" + msgs)
...
#===========KICKOUT============#       
                          ...
                          if wait["selfbot"] == True:
                           ...
                           if msg._from in admin:
                           	if msg.toType == 2:
                                  ...
                                  sw.acceptGroupInvitationByTicket(msg.to,Ticket)
                                  dz.acceptGroupInvitationByTicket(msg.to,Ticket)
                                  _name = text.lower().replace('.meneng','')
                                  gs = ki.getGroup(msg.to)
                                  gs = kk.getGroup(msg.to)
                                  gs = kc.getGroup(msg.to)
                                  gs = km.getGroup(msg.to)
                                       ...
                                       for target in targets:
                                        if not target in Bots:
                                           if not target in admin:
                                              if not target in staff:
                                                 try:
                                                      random.choice(ABCD).kickoutFromGroup(msg.to, [target])
                                                      G = cl.getGroup(msg.to)
                                                      G.preventedJoinByTicket = True
                                                      cl.updateGroup(G)
                          ...
                          if msg.toType != 2: return cl.sendReplyMessage(msg_id, to, 'Failed cancel all pending members, use this command only on group chat')
                          group = cl.getCompactGroup(to)
                          if not group.invitee:
                              return cl.sendReplyMessage(msg_id, to, 'Failed cancel all pending members, no pending member in list')
                          for member in group.invitee:
                              if member.mid == '.batal':
                                  continue
                              try:
                                  ka,kr.cancelGroupInvitation(to, [member.mid])
                              except TalkException as talk_error:
                                  return cl.sendReplyMessage(msg_id, to, 'Failed cancel all pending members, the reason is `%s`' % talk_error.reason)
                              time.sleep(0.8)
                          cl.sendReplyMessage(msg_id, to, 'Success cancel all pending members, totals %i pending members' % len(pendings)) 
...
#===========COMMAND BLACKLIST============#
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in owner or msg._from in admin:
                               ...
                               cl.sendMessage(msg.to, "sc keren")
#===========COMMAND SET============#
                        ...
                        elif 'Sleave: ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('Sleave: ','')
                              if spl in [""," ","\n",None]:
...
#=================================[ STAMINA BOT ]================================================                               
                            ...
                            if msg._from in owner or msg._from in admin:
                               ...
                               try:ka.inviteIntoGroup(to, [Fmid]);has = "OK"
                               except:has = "NOT"
                               try:ka.kickoutFromGroup(to, [Fmid]);has1 = "OK"
                               except:has1 = "NOT"
                               if has == "OK":sil = "🔋██ full 100%"
                               else:sil = "🔌█▒ Low 0%"
                               if has1 == "OK":sil1 = "🔋██ full 100%"
                               ...
                               try:kr.inviteIntoGroup(to, [Gmid]);has = "OK"
                               except:has = "NOT"
                               try:kr.kickoutFromGroup(to, [Gmid]);has1 = "OK"
                               except:has1 = "NOT"
                               if has == "OK":sil = "🔋██ full 100%"
                               else:sil = "🔌█▒ Low 0%"
                               if has1 == "OK":sil1 = "🔋██ full 100%"
                               else:sil1 = "🔌█▒ Low 0%"
                               kr.sendMessage(to, "Status:\n\n🔴Kick : {} \n🔴Invite : {}".format(sil1,sil))
                            ...
                            if msg._from in owner:
                              if settings["autoJoinTicket"] == True:
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     ka.sendMessage(msg.to, "Asɪsᴛ 6 ɢᴏ : %s" % str(group.name))
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     kr.sendMessage(msg.to, "Asɪsᴛ 7 ɢᴏ : %s" % str(group.name))
                                     groupl = kr.findGroupByTicket(ticket_id)
